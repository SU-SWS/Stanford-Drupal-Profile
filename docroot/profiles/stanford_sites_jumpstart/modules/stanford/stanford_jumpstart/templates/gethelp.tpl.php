...
/**
 * @file
 * Template file for "Get Help" page
 */

$help_setttings = stanford_jumpstart_help_get_settings();
$help_text = token_replace(nl2br(strip_tags($help_setttings['help_text'])));
$url = token_replace($help_setttings['request_help_url']);
$gethelp = l('Request Assistance', $url, array('attributes' => array('class' => array('btn', 'btn-request'), 'target' => 'blank')));

?>
<div class="block-extrainfo block-need-assistance">
<h2>Need assistance with your site?</h2>
<?php print $help_text; ?>
<p><?php print $gethelp; ?></p>
</div>

<!--<div class="block-extrainfo block-request-training">
<h2>Get Tech Training</h2>
<p>You may participate in tech training as part of your Jumpstart package.</p>
