 ...
 */
function stanford_sites_jumpstart_install_tasks(&$install_state) {
 ...
 */
function stanford_sites_jumpstart_install_tasks_alter(&$tasks, &$install_state) {
 ...
 * @param $install_state
 */
function stanford_sites_jumpstart_install_verify_requirements(&$install_state) {
 ...
 */
function stanford_sites_jumpstart_form_install_configure_form_alter(&$form, &$form_state) {
  itasks_form_install_configure_form_alter($form, $form_state);
  $form["#validate"][] = "stanford_sites_jumpstart_form_install_configure_form_alter_validate";
  $form["#submit"][] = "stanford_sites_jumpstart_form_install_configure_form_alter_submit";
}
 ...
 * @param $form_state
 */
function stanford_sites_jumpstart_form_install_configure_form_alter_validate(&$form, &$form_state) {
 ...
 * @param $form_state
 */
function stanford_sites_jumpstart_form_install_configure_form_alter_submit(&$form, &$form_state) {
