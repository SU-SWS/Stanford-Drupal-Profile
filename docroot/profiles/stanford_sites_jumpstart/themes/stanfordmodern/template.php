 ...
 */
function stanfordmodern_html_head_alter(&$head_elements) {
 ...
 */
function stanfordmodern_breadcrumb($variables) {
 ...
 */
function stanfordmodern_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function stanfordmodern_preprocess_search_block_form(&$vars) {
 ...
 */
function stanfordmodern_preprocess_html(&$variables) {
 ...
 */
function stanfordmodern_preprocess_page(&$variables) {
