...
class AddFeaturesPage extends \ITasks\AbstractInstallTask {
  ...
  public function execute(&$args = array()) {
    ...
    $addblocks = l('Request This Feature', 'https://stanforduniversity.qualtrics.com/SE/?SID=SV_1EK9guIGepRtvwh&source=soe&Name=[current-user:name]&Email=[current-user:mail]&URL=[site:url]&Feature=Add%20Blocks%20or%20Change%20Block%20Layouts', array('attributes' => array('class' => array('btn', 'btn-request'), 'target' => 'blank')));
    $admin_access = l('Request Full Admin Access', 'https://stanforduniversity.qualtrics.com/SE/?SID=SV_1EK9guIGepRtvwh&source=soe&Name=[current-user:name]&Email=[current-user:mail]&URL=[site:url]&Feature=Full%20Administrative%20Access', array('attributes' => array('class' => array('btn', 'btn-request'), 'target' => 'blank')));
    $site_protection = l('Request This Feature', 'https://stanforduniversity.qualtrics.com/SE/?SID=SV_1EK9guIGepRtvwh&source=soe&Name=[current-user:name]&Email=[current-user:mail]&URL=[site:url]&Feature=In-Development%20Site%20Protection', array('attributes' => array('class' => array('btn', 'btn-request'), 'target' => 'blank')));
    $googleanalytics = l('Request This Feature', 'https://stanforduniversity.qualtrics.com/SE/?SID=SV_1EK9guIGepRtvwh&source=soe&Name=[current-user:name]&Email=[current-user:mail]&URL=[site:url]&Feature=Google%20Analytics', array('attributes' => array('class' => array('btn', 'btn-request'), 'target' => 'blank')));
    $afsquota = l('Request This Feature', 'https://stanforduniversity.qualtrics.com/SE/?SID=SV_1EK9guIGepRtvwh&source=soe&Name=[current-user:name]&Email=[current-user:mail]&URL=[site:url]&Feature=Increased%20File%20Storage', array('attributes' => array('class' => array('btn', 'btn-request'), 'target' => 'blank')));
    $rss = l('Request This Feature', 'https://stanforduniversity.qualtrics.com/SE/?SID=SV_1EK9guIGepRtvwh&source=soe&Name=[current-user:name]&Email=[current-user:mail]&URL=[site:url]&Feature=Display%20an%20External%20RSS%20Feed', array('attributes' => array('class' => array('btn', 'btn-request'), 'target' => 'blank')));
