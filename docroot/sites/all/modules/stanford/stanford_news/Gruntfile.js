...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dist: {
        files: {
          'css/stanford_news.css': 'scss/stanford_news.scss',

          // Stanford News Views.
          'modules/stanford_news_views/css/stanford_news_views.css': 'modules/stanford_news_views/scss/stanford_news_views.scss',
          'modules/stanford_news_views/css/stanford_news_views_grid.css': 'modules/stanford_news_views/scss/stanford_news_views_grid.scss'
        }
      }
    },
    drush: {
